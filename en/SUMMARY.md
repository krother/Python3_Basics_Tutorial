...
* [Extracting data](parsing/extracting_information.md)
  * [Using format strings](parsing/string_methods.md)
  * [Reading data from text files](parsing/parsing.md)
* [Writing files](parsing/writing_files.md)
  * [Writing a text file](tables/writefile.md)
  * [Processing multiple tables](tables/multiple_tables.md)
* [Working with two-dimensional lists](tables/tables_2d.md)
